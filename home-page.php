                            ...
                            <div class="custom-w-1250 background-effect about-sec-wrapper">
                                <div class="video-sec-content-wrapper">
                                    <div class="video-sec-content">
                                        ...
                                        <p>آژانس دیجیتال مارکتینگ رامان با هدف توسعه بازار دیجیتال برای کسب‌وکارها تأسیس
                                            شده
                            ...
                            <div class="ra-form-wrapper background-effect">
                                ...
                                <div class="cta-form">
                                    ...
                                    <div class="contact-info-wrapper">
                                        ...
                                        <span class="contact-info-item address">مشهد بلوار کوثر میدان پژوهش کارخانه نوآوری مشهد
                                        ...
                                        <span class="contact-info-item call-num">09306625562<svg width="24" height="24"
                                                                                                 viewBox="0 0 24 24"
                                                                                                 fill="none"
                                        ...
                                        <span class="contact-info-item email">info@raman.agency
                                            <svg width="24"
                                                 height="25"
                                                 viewBox="0 0 24 25"
                                                 fill="none"
