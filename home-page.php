...
<!--                            <div class="min-vh-100 w-100 hero-section-overlay">-->
                                ...
                                <div class="glow-button-wrapper">
                                    <a href="#" class="glow-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#010101" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>
