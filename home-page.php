    ...
    <div class="raman-home-page container-fluid p-0">
        <div class="main-wrapper d-flex flex-column" style="height: 1300px;">
            <div style="background-color:#030303" class="raman-container flex-grow-1 p-0">
                ...
                <div class="ra-hero-section row p-0">
                    ...
                    <div class="col-12 p-0">
                        <div class="min-vh-100 w-100 hero-section-bc-img hero-section-overlay">
                            ...
                            <div class="en-title animated-text">
                ...
                <!--section2-->
                <div class="row-background mt140 row">
                    <div class="gradient-overlay">
                        ...
                        <div class="ra-about-sec mt140 row">
                            <!--about-->
                            <div class="col-12">
                ...
                <!--section5-->
                <div class="ra-project-sec mt140 row">
                    <div class="col-12">
                        <div class="section-en-title glass-bc">
                            <img src='<?php echo get_template_directory_uri(); ?>/assets/images/green-light.png.webp'
                                 alt="">
...
<!--                                <div class="swiper-wrapper">-->
<!--                                    <div class="swiper-slide">-->
<!--                                        <img class="img-fluid" src="--><?php //echo get_template_directory_uri(); ?><!--/assets/images/portfolio/heave.webp"-->
<!--                                    </div>-->
<!--                                    <div class="swiper-slide">-->
<!--                                        <img class="img-fluid" src="--><?php //echo get_template_directory_uri(); ?><!--/assets/images/portfolio/heavemax.webp">-->
<!--                                    </div>-->
<!--                                    <div class="swiper-slide">-->
<!--                                        <img class="img-fluid" src="--><?php //echo get_template_directory_uri(); ?><!--/assets/images/portfolio/kinimaic.webp">-->
<!--                                    </div>-->
<!--                                    <div class="swiper-slide">-->
<!--                                        <img class="img-fluid" src="--><?php //echo get_template_directory_uri(); ?><!--/assets/images/portfolio/portfolio.png">-->
<!--                                    </div>-->
<!--                                </div>-->
