<header class="ra-header row">
    <div class="ra-header-wrapper">
        ...
        <div class="menu-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light main-navigation" role="navigation">
                <div class="container-fluid">
					<?php if ( function_exists( 'ra_render_main_menu' ) ) {
						ra_render_main_menu();
					} ?>
                </div>
            </nav>
...
<div class="mobile-menu-overlay" id="mobileMenuOverlay">
    <div class="mobile-menu-content glass-effect">
        ...
        <div class="mobile-menu-items-wrapper drill-down-container">
			...
			} elseif ( function_exists( 'ra_render_main_menu' ) ) {
				ra_render_main_menu();
			}
			?>
        </div>
