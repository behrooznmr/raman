...
// global button shortcode
function raman_create_glow_button_shortcode( $atts ) {
	...
	$button_link = esc_url( $attributes['link'] );
	$button_text = esc_html( $attributes['text'] );

	$output = '<a href="' . $button_link . '" class="ra-btn glow-button">';
	$output .= '        ' . $button_text . '        ';
	$output .= '<span class="animated-border-box-glow"></span>';
	$output .= '<span class="animated-border-box"></span>';
	$output .= '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#010101" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right">';
	$output .= '<path d="M7 7h10v10"></path>';
	$output .= '<path d="M7 17 17 7"></path>';
	$output .= '</svg>';
	$output .= '</a>';
...
add_shortcode( 'raman_btn', 'raman_create_glow_button_shortcode' );

//Cta Form shortcode
function raman_create_consulting_form_shortcode() {
	ob_start();
	?>
    <div id="raCtaFrom" class="ra-cta-form-sec row row-mt ">
        <div class="ra-form-wrapper">
            <div class="background-gradient-circle"></div>
            <div class="background-gradient-circle-2"></div>
            <div class="left-column-img">
                <div class="img-loop">
                    <img class="cta-form-img img-fluid"
                ...
                <div class="contact-info-wrapper">
					<?php if ( ! wp_is_mobile() ): ?>
                        <div>
                            ...
                            <span class="contact-info-item call-num">
