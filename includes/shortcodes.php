...
function create_glow_button_shortcode( $atts ) {
...
add_shortcode( 'raman_btn', 'create_glow_button_shortcode' );
...
add_shortcode( 'raman_cta_form', 'create_consulting_form_shortcode' );