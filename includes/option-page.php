...
function RCP_render_settings_page() {
	...
	$items = [
		...
		'custom-css-js'         => ['icon' => 'javascript.png', 'label' => 'Dashboard Fonts'],
...
//custom code snippets settings page
...
//custom post type settings page
